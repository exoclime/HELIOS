...
class Rayleigh_scat(object):
    ...
    def index_h2o(lam, press, temp, f_h2o):
        ...
        dens = f_h2o * press * sd.species_lib["H2O"].weight * pc.AMU / (pc.K_B * temp)  # mass density of water
    ...
    def n_ref_h2o(press, temp, f_h2o):
        ...
        n_ref = f_h2o * press / (pc.K_B * temp)  # this is the actual number density of water
