...
Note that HELIOS was developed and tested with Python 3.4. It has not been tested with earlier versions of Python.
...
Sets the value of the diffusivity factor. If you are not sure, pick 2.
    ...
    f factor (number; typically 0.25 - 1)

The f factor determines the heat redistribution efficiency in the atmosphere. For day-side emission spectra one typically assumes f = 2/3 = 0.6667. For no redistribution (substellar point) f = 1 and for a full/global redistribution f = 0.25.
